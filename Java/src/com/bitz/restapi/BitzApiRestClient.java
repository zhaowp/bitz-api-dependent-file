...
public class BitzApiRestClient {

    private String apiKey;
    private String secretKey;
    private String tradePwd;

    private static String WEB_BASE = "https://apiv2.bibidev.com"; //
     ...
     * ------------------------------------------------------------------
     */
    public BitzApiRestClient(String api_key,String secret_key){
        this.apiKey = api_key;
        this.secretKey = secret_key;
        this.tradePwd = "";
    }

    public BitzApiRestClient(String api_key,String secret_key, String tradePwd){
        this.apiKey = api_key;
        this.secretKey = secret_key;
    ...
    private String market_api(String path, Map<String,String> params){
        ...
        try{
            result = HttpUtilManager.getInstance().requestHttpGet(BitzApiRestClient.WEB_BASE, path, strParams);
        }catch(Exception e){
    ...
    private String sign_api(String path, Map<String,String> params){
        ...
        //
        try{
            result = HttpUtilManager.getInstance().requestHttpPost(BitzApiRestClient.WEB_BASE, path, params);
        }catch(Exception e){
     ...
     * https://apidoc.bit-z.pro/cn/market-quotation-data/Get-the-tickerall.html
     * ------------------------------------------------------------------
     */
