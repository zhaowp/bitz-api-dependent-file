...
namespace BitzRestApi.rest
{
    class BitzApiRestClient
    {
        /**
         * ------------------------------------------------------------------
         * @param apiKey        必须
        ...
        private String market_api(String path, Dictionary<String, String> paras)
        {
            ...
            try
            {
                result = HttpUtilManager.getInstance().requestHttpGet(BitzApiRestClient.WEB_BASE, path, strparas);
            }
            catch (Exception e)
            {
                throw e;
        ...
        private String sign_api(String path, Dictionary<String, String> paras)
        {
            ...
            try
            {
                result = HttpUtilManager.getInstance().requestHttpPost(BitzApiRestClient.WEB_BASE, path, paras);
            }
            catch (Exception e)
            {
                throw e;
